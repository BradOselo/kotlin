...
private fun IrDeclaration.isFieldEmptyOrKnownAtCompileTime() = when (this) {
    is IrField -> !isReal
    is IrProperty -> !isReal || backingField == null || isConst
    else -> true
}
...
internal fun IrClass.hasConstStateAndNoSideEffects(context: Context): Boolean {
    ...
    val parent = getSuperClassNotAny()
    return (parent == null || parent.hasConstStateAndNoSideEffects(context)) &&
            this.declarations.all { it.isFieldEmptyOrKnownAtCompileTime() } &&
